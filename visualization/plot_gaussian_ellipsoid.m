function h = plot_gaussian_ellipsoid(m, C, lineWidth, barva, sdwidth, npts, axh)
...
switch numel(m)
   case 2, h=show2d(m(:),C,lineWidth,barva,sdwidth,npts,axh);
...
%-----------------------------
function h = show2d(means, C, lineWidth, barva, sdwidth, npts, axh)
...
h = plot(bp(1,:), bp(2,:), '-', 'parent', axh, 'LineWidth', lineWidth, 'color', barva);
